...
export function ShareAreasPage() {
    return (
        <div className="container share-areas-page">
            <Helmet>
                <title>Společné prostory — Privát Nováč | Kuchyňka, zahrada, bazén a altán</title>
                <meta name="description" content="Společné prostory v Privát Nováč: plně vybavená kuchyňka, zahrada s bazénem a altánem, venkovní gril a domácí letní kino. Ideální pro rodiny i cyklisty." />
            </Helmet>
            <Header />
